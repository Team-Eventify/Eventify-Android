...
public final class ProfileViewModel_MembersInjector implements MembersInjector<ProfileViewModel> {
  ...
  public ProfileViewModel_MembersInjector(Provider<AuthProvider> authProvider) {
    this.authProvider = authProvider;
  }

  public static MembersInjector<ProfileViewModel> create(Provider<AuthProvider> authProvider) {
    return new ProfileViewModel_MembersInjector(authProvider);
  }
